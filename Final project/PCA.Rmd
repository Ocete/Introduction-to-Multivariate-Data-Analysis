...
plotProportionsTogether<-function(eigen_values, eigen_values_z) {
  ...
  plot(ks, props, col="red", type="b", xlab = 'Number of PCs used', ylab = 'Proportion of variance', xlim=c(0,r))
  grid()
...
plot(rep(1:r), eigen_values_z, type='b', col='blue', xlab='Eigen-value number', ylab='Eigen-value value')
```